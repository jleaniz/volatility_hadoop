...
nav.register_element('frontend_top', Navbar(
    ...
    Subgroup(
        ...
        Text('Proxy'),
        Separator(),
        Link('Endpoint malware', '/proxy/endpoint'),
        Link('Data transfers', '/proxy/top/transfers'),
        Link('Most visited URLs', '/proxy/top/visited'),
        Link('Uncommon User-Agents', '/proxy/uncommon/useragent'),
        Link('Intelligence feeds', '/proxy/intel/match'),
        Separator(),
        Text('Firewall'),
        Separator(),
